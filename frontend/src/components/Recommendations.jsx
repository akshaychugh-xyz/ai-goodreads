    ...
    return (
        <div className="space-y-6">
            {hasImportedData ? (
                                        ...
                                        {recommendations.map((book, index) => (
                                            <li key={index} className="bg-white/10 p-4 rounded-lg text-white flex">
                                                ...
                                                <div>
                                                    ...
                                                    {index === 3 && <p className="italic">From your 'read' shelf</p>}
                                                </div>
                                            </li>
                                        ))}
                                    </ul>
                ...
                <div className="bg-white/10 p-6 rounded-lg shadow-lg flex items-center justify-center">
                    <p className="text-white text-center">Welcome back! You haven't imported any books yet. Use the import feature to get started.</p>
                </div>
            )}
        </div>
    );
