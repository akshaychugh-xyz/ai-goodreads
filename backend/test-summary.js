...
// Force use of Supabase for testing
...
// Fallback summary generator when Gemini API is unavailable
...
async function testSummaryGeneration() {
  try {
    console.log('Testing summary generation for demo user...');
    
    const userData = await getUserReadingData(1);
